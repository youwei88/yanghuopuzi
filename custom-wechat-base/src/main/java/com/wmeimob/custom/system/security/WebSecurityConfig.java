...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    private static final String LOGIN_URL="/core/oauth2";
    private static final String OAUTH2_CALLBACK_URL="/core/saveOpenid";
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .authorizeRequests()
                // 允许登陆接口匿名
                .antMatchers(LOGIN_URL,OAUTH2_CALLBACK_URL).permitAll()
                // 除上面外的所有请求全部需要鉴权认证
